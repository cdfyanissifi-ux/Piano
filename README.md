...
const SONGS_CONFIG = [
  {
    file:   './music/G-Eazy & Halsey - Him & I (Official Video).mp3',   // ← nom du fichier MP3
    title:  'Him & I',  // ← nom affiché
    artist: 'G-Eazy & Halsey',              // ← artiste affiché
    emoji:  '🌹',                   // ← emoji affiché
  },
  {
    file:   './music/Bessan Ismail - Al Harbein (Official Music Video)  بيسان اسماعيل - الحربين.mp3',
    title:  'Al Harbein',
